...
require File.dirname(__FILE__) + '/scaffold/imports'
...
require File.dirname(__FILE__) + '/scaffold/repository/repository_generator'
require File.dirname(__FILE__) + '/scaffold/jsp/jsp_generator'
